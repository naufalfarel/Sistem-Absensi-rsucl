...
export function OvertimeRequestPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-6 pb-10 text-slate-800">
      ...
      {/* Form Section Modal Dialog */}
      {showForm && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
          <div className="fixed inset-0 bg-black/50 backdrop-blur-xs animate-fade-in" onClick={() => setShowForm(false)} />
          <div className="relative bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden z-10 my-auto max-h-[92vh] flex flex-col font-sans border border-slate-100 p-4 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 overflow-y-auto flex-1 text-left pr-1">
