    ...
    <div className="max-w-6xl mx-auto space-y-5">
      ...
      <div className="flex gap-3 items-center">
        ...
        {filterStatus !== "all" && (
          <button
            ...
            className="text-[12px] text-gray-500 bg-white border border-gray-100 rounded-xl px-3 py-2.5 hover:bg-gray-50 shadow-sm"
          >
            Reset filter
          </button>
        )}
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <tbody>
              {loading && (
                <tr>
                  <td
                    colSpan={8}
                    className="text-center py-5 text-gray-400 text-[12px]"
                  >
              ...
              {filtered.map((emp) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5 text-[13px] text-gray-600">
                      {getDuration(emp.checkIn, emp.checkOut)}
                    </td>
                    <td className="px-4 py-3.5">
                      <div className="flex flex-col gap-1 items-start">
                        <span
                          className="inline-flex items-center gap-1.5 text-[11px] font-semibold px-2.5 py-1 rounded-full border border-dashed"
                          style={{
                            color: sc.color,
                            background: sc.bg,
                        ...
                        {emp.checkinPunctuality &&
                          (emp.status === "working" ||
                            ...
                            <span
                              ...
                              style={{
                                color:
                                  emp.checkinPunctuality === "tepat_waktu"
                                    ? "#16A34A"
                                    : emp.checkinPunctuality === "toleransi"
                                      ? "#D97706"
                                      : "#DC2626",
                                backgroundColor:
                                  emp.checkinPunctuality === "tepat_waktu"
        ...
        {filtered.length === 0 && !loading && (
          <div className="text-center py-5 text-gray-300 text-[11px]">
        ...
        <div className="px-5 py-3 border-t border-gray-50 flex items-center justify-between bg-gray-50/30">
          ...
          <p className="text-[12px] text-gray-400">
            Diperbarui otomatis dari server
          </p>
        </div>
      </div>
              ...
              >
                {selected.profile_picture ? (
                  ...
                  <span
                    ...
                    style={{ color: statusMap[selected.status].color }}
                  >
                    {selected.name
                      .replace(/^(dr\.|Ns\.|Dr\.)\s*/i, "")
                      .charAt(0)}
            ...
            <div className="space-y-2.5 bg-gray-50 rounded-xl p-4 mb-5">
              {[
                ...
                },
                {
                  ...
                  v:
                    selected.checkIn +
                    (selected.checkinDistance !== undefined &&
                    selected.checkinDistance !== null
                      ? ` (${selected.checkinDistance}m dari RSUCL)`
                      : ""),
                },
                {
                  l: "Jam Keluar",
                  v:
                    (selected.checkOut || "Belum checkout") +
                    (selected.checkoutDistance !== undefined &&
                    selected.checkoutDistance !== null
                      ? ` (${selected.checkoutDistance}m dari RSUCL)`
                      : ""),
                },
                {
                  l: "Status",
                  v:
                    selected.checkinPunctuality &&
                ...
                ...(selected.checkinLocationNote
                  ? [{ l: "Posisi", v: selected.checkinLocationNote }]
                  : []),
                ...(selected.checkoutLocationNote
                  ? [{ l: "Lokasi Pulang", v: selected.checkoutLocationNote }]
                  : []),
              ].map(({ l, v }, i) => (
