...
export function ReportsTab() {
  ...
  // 1st card rate (Kehadiran Bulan Ini) - dynamic calculation based on current month presence
  const getMonthlyAttendanceRate = () => {
    ...
    if (total === 0) return 97; // realistic fallback
    ...
    <div className="max-w-6xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          {
            label: 'Keterlambatan',
            value: `${summary?.this_month.telat ?? 5} org`,
            trend: '~ 4 org',
            isPositive: true,
            icon: Clock,
            color: '#D97706',
          ...
          {
            label: 'Alpha',
            value: `${summary?.this_month.alpha ?? 1} org`,
            trend: '~ 2 org',
            isPositive: true,
            icon: AlertTriangle,
            color: '#DC2626',
          ...
          {
            label: 'Cuti & Izin',
            value: `${summary?.this_month.cuti ?? 3} org`,
            trend: '~ 5 org',
            isPositive: false,
            icon: Calendar,
            color: '#7C3AED',
          ...
          return (
            <div key={i} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${k.trendBg}`}>
                  {k.trend}
                </div>
              </div>
